...
//    public static ArrayList<String> imgSelectSourceArr = new ArrayList<>();    // img-logo Source
    ...
    public BaseSourse() {
        addBaseNews("rian", "ua.rian.ru", "img");
        addBaseNews("ZAXID", "ZAXID.NET", "img");
        addBaseNews("RIA_news", "rian.com.ua", "img");
        addBaseNews("kp", "kp.ua", "img");
    }

    private static void addBaseNews(String idSelectSource, String nameSelectSource, String imgSelectSource) {   //  id, name, img-logo Source
